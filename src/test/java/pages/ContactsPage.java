...
public class ContactsPage extends BasePage{
    ...
    public ContactsPage(WebDriver driver){
        ...
        public boolean getDataFromContactList(Contact contact){
            ...
            WebElement elementAddress = driver.findElement(
                    By.xpath("//input[@placeholder='Address')]"));
            String elementAddressValue = elementAddress.getAttribute("value");

            WebElement elementDescription = driver.findElement(
                    By.xpath("//input[@placeholder='description')]"));
            String elementDescriptionValue = elementAddress.getAttribute("value");

            Contact ListContact = new Contact();
            listContact.setName(elementNameValue);
            listContact.setName(elementLastNameValue);
            listContact.setName(elementPhoneValue);
            listContact.setName(elementEmailValue);
            listContact.setName(elementAddressValue);
            listContact.setName(elementDescriptionValue);
